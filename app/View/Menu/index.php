<nav x-data="{ mobileMenuIsOpen: false }" @click.away="mobileMenuIsOpen = false" class="dark flex items-center justify-between border-b border-slate-300 px-6 py-4 dark:border-slate-700 bg-black" aria-label="penguin ui menu">
    <!-- Brand Logo -->
