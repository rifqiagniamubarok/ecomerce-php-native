<div class="bg-slate-200">
    <div class="w-screen h-screen flex flex-col justify-center items-center gap-2">
        <div class="border shadow-md px-2 md:px-4 py-4 md:py-8 rounded-md w-[250px] md:w-[400px] bg-white">
            <div class="w-full">
                <form class="space-y-1 md:space-y-4 w-full" method="post" action="/login">
                    ...
                    <div class="flex justify-center gap-2 mt-4 md:mt-0 text-xs md:text-base">
                        <p>Belum punya akun ?</p>
                        <a href="/register" class="hover:text-blue-500">daftar disini</a>
                    </div>
                </form>
            </div>
        </div>
        <p>
            <a href="/admin/login" class="hover:text-blue-500 text-xs md:text-sm">Masuk sebagai admin</a>
        </p>
    </div>
</div>